...
$gemfire_url=json_decode($vcap_services2)->{'user-provided'}[0]->{'credentials'}->{'GEMFIRE_URL'};

if (isset($_POST["type"])) {
	if ($_POST["type"] == "TABLE") {

		$ch = curl_init();
		//curl_setopt($ch, CURLOPT_URL, "http://localhost:8081/gemfire-api/v1/TaxiData/LATEST_DATA");
		curl_setopt($ch, CURLOPT_URL, $gemfire_url."TaxiData/LATEST_DATA");
		...
		$ch = curl_init();
		//curl_setopt($ch, CURLOPT_URL, "http://localhost:8081/gemfire-api/v1/ProcessData/LATEST_DATA");
		...
		$ch = curl_init();
		//curl_setopt($ch, CURLOPT_URL, "http://localhost:8081/gemfire-api/v1/RouteData/LATEST_DATA?limit=6");
		...
		$ch = curl_init();
		//curl_setopt($ch, CURLOPT_URL, "http://localhost:8081/gemfire-api/v1/FreeTaxiList/LATEST_DATA?limit=100");
		curl_setopt($ch, CURLOPT_URL, $gemfire_url."/FreeTaxiList/LATEST_DATA?limit=100");
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
